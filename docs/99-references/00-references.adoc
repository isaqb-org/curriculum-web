...
- [[[abbott,Abbott+2010]]] Abbott, M. L., M. T. Fisher: The Art of Scalability, Addison-Wesley 2010
...
- [[[rfchttpcachegroups,RFC9875]]]  Nottingham, M.: RFC9875, HTTP Cache Groups . https://datatracker.ietf.org/doc/rfc9875/

**S**

- [[[schulte-coerne, Schulte-Coerne 2025]]] Schulte-Coerne, T., van Lessen, T.: Web Frontend Integration Patterns. In Proceedings of the 30th European Conference on Pattern Languages of Programs, People, and Practices (EuroPLoP 2025), Irsee, Germany, July 2025
...
- [[[websockets,WebSockets]]] WebSockets - http://www.whatwg.org/specs/web-apps/current-work/multipage/network.html#network
