...
<<<
:sectnums:
include::01-grundlagen/00-structure.adoc[{include_configuration}]

<<<
include::02-protokolle/00-structure.adoc[{include_configuration}]

<<<
include::03-architekturstile/00-structure.adoc[{include_configuration}]

<<<
include::04-technologie/00-structure.adoc[{include_configuration}]

<<<
include::05-entwurf/00-structure.adoc[{include_configuration}]

<<<
include::06-qualitaet/00-structure.adoc[{include_configuration}]
