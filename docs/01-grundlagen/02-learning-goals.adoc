...
**Was sollen die Teilnehmer können?**
  ...
  * Die Teilnehmer können den Unterschied zwischen GET, PUT, POST, PATCH und DELETE-Requests erläutern.
...
**Was sollen die Teilnehmer kennen?**
  ...
  * Die  Teilnehmer kennen die allgemeinen Anforderungen der Web Content Accessibility Guidelines (WCAG), die unter dem Begriff Barrierefreiheit zusammengefasst sind.
...
* Participants can explain the difference between GET, PUT, POST, PATCH and DELETE requests.
...
* The participants know the general requirements of the Web Content Accessibility Guidelines (WCAG), which are summarized under the term accessibility.
